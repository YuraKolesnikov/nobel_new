...
(function e(t, n, r) {
  ...
  2: [function (require, module, exports) {
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      ...
      EventEmitter.prototype.emit = function (type, arg) {
        this.events[type] ? this.events[type].forEach(function (callback) {
          return callback(arg);
        }) : 0;
      };
  ...
  3: [function (require, module, exports) {
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      var Model = require('./model/Model'); //var DropdownModel = require('./model/DropdownModel');


      var TableModel = require('./model/TableModel');

      var model = new Model('data/laureate.json', 'dataLoaded'); //var dropdownModel = new DropdownModel('data/country.json', 'dropdownDataLoaded');

      var tableModel = new TableModel('data/laureate.json', 'tableDataLoaded'); //setTimeout(() => console.log(model.getData()), 1000)
      ...
      var sayHello = function sayHello(name) {
        console.log("Oh hi ".concat(name, "!"));
      };

      sayHello('Mark');
    }).call(this, require("v3go1D"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_d28a994e.js", "/");
  }, {
  ...
  5: [function (require, module, exports) {
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      ...
      TableModel.prototype.filterData = function (oFilter) {
        ...
        this._aFilteredData = this._prepareData().filter(function (oObject) {
